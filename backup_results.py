...
def main():
	...
	new_files_location='./serpent_cases_backup'
	...
	bumat_filename='BNB_MCFR_1_input.bumat41'
	for case_folder in case_folder_names:
		for radius_folder in radius_folder_names:
			...
			copyfile(old_files_location+"/"+case_folder+"/"+radius_folder+"/"+bumat_filename,
				new_files_location+"/"+case_folder+"/"+radius_folder+"/"+bumat_filename)
